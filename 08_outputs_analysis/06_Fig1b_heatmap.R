...
# and creates a heatmap for Figure 1b 
#
# Author: Marc Grünig
# Date: 7.2.2025
#
...
write_csv(df_plot_heatmap, paste0(path, "/figures/plot_data/fig1b_heatmap.csv"))
...
print(combined_plot)
ggsave(combined_plot, filename = paste0(path, "/svd_simulations/results_eu/figures/Fig1b_heatmap_VPD.png"), width = 5, height = 5)
...
# ggsave(legend_rcp, filename = paste0(path, "/figures/heatmap_legend.png"), width = 5, height = 5)
...
plot(legend_heat)
# ggsave(legend_heat, filename = paste0(path, "/figures/heatmap_legend_heat.png"), width = 5, height = 5)
